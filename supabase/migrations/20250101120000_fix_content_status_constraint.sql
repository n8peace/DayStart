...
COMMENT ON COLUMN public.content_blocks.status IS 'Current state in the generation pipeline. Valid values: pending, content_generating, content_ready, content_failed, script_generating, script_generated, script_failed, audio_generating, ready, audio_failed, failed, expired, retry_pending';
